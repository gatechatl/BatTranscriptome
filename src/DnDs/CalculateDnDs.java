...
public class CalculateDnDs {	
			...
			while (in.ready()) {
				...
				if (str.contains(">")) {
					if (count % 2 == 0 && count != 0) {
						GrabGoodAlignment(outputFileFor, str1, str2);
	...
	public static void GrabGoodAlignment(String fileName, String seq, String seq2) {
	...
	public static String trimMACSEOutput(String inputFile, String outputFile) {
		...
		try {
			...
			String seq1 = "";
			String seq1_title = ">HUMAN";
			String seq2 = "";
			String seq2_title = ">BAT";
			FileInputStream fstream = new FileInputStream(inputFile);
			DataInputStream din = new DataInputStream(fstream); 
			BufferedReader in = new BufferedReader(new InputStreamReader(din));
			while (in.ready()) {
